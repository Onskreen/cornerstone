...
public class AppTransition implements Dump {
    ...
    private static final boolean DEBUG_CORNERSTONE = WindowManagerService.DEBUG_CORNERSTONE;
    ...
    Animation loadAnimation(WindowManager.LayoutParams lp, int transit, boolean enter,
                            int appWidth, int appHeight, boolean isMainPanel, boolean isCSPanel0, boolean isCSPanel1, boolean isPortraitMode, boolean isLandscapeMode) {
        Animation a;
